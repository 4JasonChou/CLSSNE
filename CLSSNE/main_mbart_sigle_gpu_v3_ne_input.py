...
def CreateTrainingDataLoader( tokenizer , envBatchSize , inputCsvNameList) :
    ...
    for inputCsvName in inputCsvNameList :
        ...
        for index,rowData in inputCsv.iterrows() :
            ...
            tmpContext = NameEntitysHandler(rowData['name_entity']) + '[CL]' + rowData["context"]
...
if __name__ == "__main__":
    ...
    # Env Par :
    trainingDataFileName = ['../Dataset/EN2ZHSUM_train_v3_ne_part1.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part2.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part3.csv']
    testingDataFileName = '../Dataset/EN2ZHSUM_test_v3_ne.csv' 
    modelName = 'Summary_fzpar_en2zh_v3_ne_input'
    mEnv_batch_szie = 2 
    mTrainEpoch = 10
    accumulation_step = 8
    ...
    for epoch in range(mTrainEpoch):
        ...
        for index , row in testingPd.iterrows() :
            tmpContext = NameEntitysHandler(row['name_entity']) + '[CL]' + row['context']
