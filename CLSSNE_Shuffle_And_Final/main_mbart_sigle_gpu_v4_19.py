...
if __name__ == "__main__":
    ...
    # Env Par :
    trainingDataFileName = ['../Dataset/EN2ZHSUM_train_v3_ne_part1_keyword_emptyfix_upset_19chnage.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part2_keyword_emptyfix_upset_19chnage.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part3_keyword_emptyfix_upset_19chnage.csv']
    ...
    # Init Logger : 
    logging_file = "mBartFineturn_v19c.log".format(modelName)
    logging.basicConfig(filename=logging_file, level=logging.INFO) 
    logging.info( TimeMsg( "ModelTask:{}, Traingset:{}".format(modelName,trainingDataFileName) ) )
    logging.info( TimeMsg( "Info: Predict important name-entity and summary. with 1:9 UpsetContext" ) )
    ...
    mBartTokenizer.save_pretrained("tokenizer_v19c/".format(modelName))
    ...
    for epoch in range(mTrainEpoch):
        ...
        mBartModel.save_pretrained("Checkpoint_v19c/point_{}".format(str(epoch)))
