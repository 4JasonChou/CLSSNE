...
if __name__ == "__main__":
    ...
    # Env Par :
    trainingDataFileName = ['../Dataset/EN2ZHSUM_train_v3_ne_part1_keyword_emptyfix_upset_37change.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part2_keyword_emptyfix_upset_37change.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part3_keyword_emptyfix_upset_37change.csv']
    ...
    # Init Logger : 
    logging_file = "mBartFineturn_v37c.log".format(modelName)
    ...
    for epoch in range(mTrainEpoch):
        ...
        mBartModel.save_pretrained("Checkpoint_v37c/point_{}".format(str(epoch)))
