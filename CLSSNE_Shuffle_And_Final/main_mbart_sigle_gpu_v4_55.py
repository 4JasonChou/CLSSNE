...
if __name__ == "__main__":
    ...
    # Env Par :
    trainingDataFileName = ['../Dataset/EN2ZHSUM_train_v3_ne_part1_keyword_emptyfix_upset_half.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part1_keyword_emptyfix_upset_half.csv',
                            '../Dataset/EN2ZHSUM_train_v3_ne_part1_keyword_emptyfix_upset_half.csv']
    ...
    # Init Logger : 
    logging_file = "mBartFineturn_vHalf.log".format(modelName)
    logging.basicConfig(filename=logging_file, level=logging.INFO) 
    logging.info( TimeMsg( "ModelTask:{}, Traingset:{}".format(modelName,trainingDataFileName) ) )
    logging.info( TimeMsg( "Info: Predict important name-entity and summary. with 50% UpsetContext" ) )
    ...
    mBartTokenizer.save_pretrained("tokenizer_vHalf/".format(modelName))
    ...
    for epoch in range(mTrainEpoch):
        ...
        mBartModel.save_pretrained("Checkpoint_vHalf/point_{}".format(str(epoch)))
